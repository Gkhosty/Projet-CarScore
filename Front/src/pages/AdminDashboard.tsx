...
export default function AdminDashboard() {
    ...
    useEffect(() => {
        async function chargerDonnees() {
            ...
            const resStats = await fetch('https://projet-carscore.onrender.com/api/admin/stats', { headers })
            const dataStats = await resStats.json()
            setStats(dataStats)

            const resUsers = await fetch('https://projet-carscore.onrender.com/api/admin/users', { headers })
            const dataUsers = await resUsers.json()
            setUsers(dataUsers.users || [])

            const resAnalyses = await fetch('https://projet-carscore.onrender.com/api/admin/analyses', { headers })
    ...
    async function desactiverUser(id: number) {
        const token = sessionStorage.getItem('token')
        await fetch(`https://projet-carscore.onrender.com/api/admin/users/${id}`, {
            method: 'PUT',
